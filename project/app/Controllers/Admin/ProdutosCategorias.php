...
class ProdutosCategorias extends Controller
{
    ...
    public function __construct()
	{
		...
		$this->model	= new ProdutosCategoriaModel();
    ...
    public function index()
    {
        ...
        echo view('admin/produtos-categoria/index.php', $this->data);
    ...
    public function create()
    {
            ...
            if(csrf_hash() === $this->request->getVar('csrf_test_name'))
            {
                ...
                if ($this->validation->withRequest($this->request)->run()){
                    ...
                    if($this->save()){
                        ...
                        if((int)$this->request->getVar('formulario_envio') === 1){
                    ...
                    return redirect()->to('/Admin/Produtos-Categorias/cadastrar');
                }
        ...
        echo view('admin/template/header.php');
        echo view('admin/template/sidebar.php');
        echo view('admin/produtos-categoria/create.php');
        echo view('admin/template/footer.php');
    ...
    public function edit($id)
    {
        ...
        echo view('admin/template/header.php');
        echo view('admin/template/sidebar.php');
        echo view('admin/produtos-categoria/edit.php', $this->data);
        echo view('admin/template/footer.php');
