...
use App\Models\Admin\ProdutosModel;
use App\Models\Admin\ProdutosCategoriaModel;
use App\Models\Admin\ProdutosImagensModel;
...
class Produtos extends Controller
{
    ...
    public function __construct()
	{
        ...
        $this->modelCategoria = new ProdutosCategoriaModel();
        $this->modelImagens = new ProdutosImagensModel();
    ...
    public function index()
    {
        ...
        echo view('admin/produtos/index.php', $this->data);
    ...
    public function create()
    {
        ...
        echo view('admin/template/header.php');
        echo view('admin/template/sidebar.php');
        echo view('admin/produtos/create.php', $this->data);
        echo view('admin/template/footer.php');
    ...
    public function edit($id)
    {
        ...
        echo view('admin/template/header.php');
        echo view('admin/template/sidebar.php');
        echo view('admin/produtos/edit.php', $this->data);
        echo view('admin/template/footer.php');
    ...
    public function galery($id)
    {
        ...
        $this->data =   [
                        'field'     => $this->model->get($id),
                        'images'    => $this->modelImagens->where('idProduto', $id)->find()
                        ];

        echo view('admin/template/header.php');
        echo view('admin/template/sidebar.php');
        echo view('admin/produtos/galery.php', $this->data);
        echo view('admin/template/footer.php');
    ...
    public function uploadImages($id)
    {
        ...
        $this->session->setFlashdata($alert, $message);
        return redirect()->to(base_url('/Admin/Produtos/galeria/'.$id));
    ...
    public function deleteImage($idImage, $idNoticia)
    {
        ...
        if($this->modelImagens->delete($idImage)){
            ...
            return redirect()->to(base_url('/Admin/Produtos/galeria/'.$idNoticia));
        }
