...
<head>
    ...
    <!--== Favicon ==-->
    <link rel="shortcut icon" href="<?= base_url()?>/assets/site/img/favicon.ico" type="image/x-icon" />
    ...
    <!--== Headroom CSS ==-->
    <link href="<?= base_url()?>/assets/site/css/headroom.css" rel="stylesheet" />
    <!--== Animate CSS ==-->
    <link href="<?= base_url()?>/assets/site/css/animate.css" rel="stylesheet" />
    <!--== Ionicons CSS ==-->
    <link href="<?= base_url()?>/assets/site/css/ionicons.css" rel="stylesheet" />
    <!--== Material Icon CSS ==-->
    <link href="<?= base_url()?>/assets/site/css/material-design-iconic-font.css" rel="stylesheet" />
    <!--== Elegant Icon CSS ==-->
    <link href="<?= base_url()?>/assets/site/css/elegant-icons.css" rel="stylesheet" />
    <!--== Font Awesome Icon CSS ==-->
    <link href="<?= base_url()?>/assets/site/css/font-awesome.min.css" rel="stylesheet" />
    <!--== Swiper CSS ==-->
    <link href="<?= base_url()?>/assets/site/css/swiper.min.css" rel="stylesheet" />
    <!--== Fancybox Min CSS ==-->
    <link href="<?= base_url()?>/assets/site/css/fancybox.min.css" rel="stylesheet" />
    <!--== Slicknav Min CSS ==-->
    <link href="<?= base_url()?>/assets/site/css/slicknav.css" rel="stylesheet" />
      ...
      <div class="row align-items-center">
        <div class="col-6 col-sm-4 col-lg-2">
          <div class="header-logo-area">
            <a href="index.html">
              <img class="logo-main" src="<?= base_url()?>/assets/site/img/logo.png" alt="Logo" />
              <img class="logo d-none" src="<?= base_url()?>/assets/site/img/logo-light.png" alt="Logo" />
            </a>
          </div>
        </div>
        <div class="col-sm-4 col-lg-8 d-none d-lg-block">
          <div class="header-navigation-area">
            <ul class="main-menu nav position-relative">
              <li class="has-submenu"><a href="#/">Início</a>
                <ul class="submenu-nav">
                  <li><a href="index.html">Home Demo 1</a></li>
                  <li><a href="index-two.html">Home Demo 2</a></li>
                </ul>
              </li>
              <li class="has-submenu full-width"><a href="#/">Produtos</a>
                <ul class="submenu-nav submenu-nav-mega">
                  ...
                  <li class="mega-menu-item"><a href="#/" class="mega-title">MEN</a>
                    <ul>
                      <li><a href="single-product-name-1.html">Bags</a></li>
                      <li><a href="single-product-name-1.html">Blazers</a></li>
                      <li><a href="single-product-name-1.html">Caps &amp; Hats</a></li>
                      <li><a href="single-product-name-1.html">Gifts</a></li>
                      <li><a href="single-product-name-1.html">Grooming</a></li>
                    </ul>
                  </li>
                </ul>
              </li>
            ...
            <ul class="header-action">
              ...
              <li class="mini-cart">
                ...
                <div class="mini-cart-dropdown">
                  <div class="cart-item">
                    <div class="thumb">
                      <img class="w-100" src="<?= base_url()?>/assets/site/img/shop/cart/1.jpg" alt="Image-HasTech">
                    </div>
                    <div class="content">
                  ...
                  <div class="cart-item">
                    <div class="thumb">
                      <img class="w-100" src="<?= base_url()?>/assets/site/img/shop/cart/2.jpg" alt="Image-HasTech">
                    </div>
                    <div class="content">
      ...
      <div class="swiper-container swiper-slide-gap home-slider-container default-slider-container">
        <div class="swiper-wrapper home-slider-wrapper slider-default">
          <div class="swiper-slide">
            <div class="slider-content-area" data-bg-img="<?= base_url()?>/assets/site/img/slider/slider-01.jpg">
              <div class="slider-content">
                <h5 class="sub-title">Promoção: R$ 299,00</h5>
                <h2 class="title">Dia das Mulheres</h2>
                <h4>Cesta Empoderada</h4>
                <p>Cesta de café da manhã especial para o Dia das Mulheres</p>
                <a class="btn-slider" href="shop.html">Comprar Agora</a>
              </div>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="slider-content-area" data-bg-img="<?= base_url()?>/assets/site/img/slider/slider-02.jpg">
              <div class="slider-content">
        ...
        <div class="row">
            ...
            <div class="feature-icon-box">
              <div class="inner-content">
                ...
                <div class="content">
                  ...
                  <p>Entrega Rápida em Cuiabá e Várzea Grande</p>
                </div>
              </div>
            </div>
            <!--== End Feature Item ==-->
          ...
          <div class="col-md-6 col-lg-4">
            ...
            <div class="feature-icon-box">
              <div class="inner-content">
                <div class="icon-box">
                  <i class="icon ei ei-icon_gift_alt"></i>
                </div>
                <div class="content">
                  <h5 class="title">Cestas Personalizadas</h5>
                  <p>Produção e Entrega no mesmo dia</p>
                </div>
              </div>
            </div>
            <!--== End Feature Item ==-->
          ...
          <div class="col-md-6 col-lg-4">
            ...
            <div class="feature-icon-box">
              <div class="inner-content mb-0">
                ...
                <div class="content">
                  <h5 class="title">Pedidos Online</h5>
                  <p>Sua compra 100% segura</p>
                </div>
              </div>
            </div>
            <!--== End Feature Item ==-->
                          ...
                          <div class="swiper-slide">
                              ...
                              <div class="inner-content">
                                <div class="product-thumb">
                                  <a href="single-product-simple.html">
                                    <img class="w-100" src="<?= base_url()?>/assets/site/img/shop/1.jpg" alt="Image-HasTech">
                                  </a>
                            ...
                            <div class="product-item">
                              <div class="inner-content">
                                <div class="product-thumb">
                                  <a href="single-product-simple.html">
                                    <img class="w-100" src="<?= base_url()?>/assets/site/img/shop/2.jpg" alt="Image-HasTech">
                                  </a>
                                  <span class="sale-title sticker">Sale</span>
                          ...
                          <div class="swiper-slide">
                            ...
                            <div class="product-item">
                              <div class="inner-content">
                                <div class="product-thumb">
                                  <a href="single-product-simple.html">
                                    <img class="w-100" src="<?= base_url()?>/assets/site/img/shop/3.jpg" alt="Image-HasTech">
                                  </a>
                                  <span class="sale-title sticker">Sale</span>
                            ...
                            <div class="product-item">
                              <div class="inner-content">
                                <div class="product-thumb">
                                  <a href="single-product-simple.html">
                                    <img class="w-100" src="<?= base_url()?>/assets/site/img/shop/4.jpg" alt="Image-HasTech">
                                  </a>
                                  <div class="product-action">
                                    <div class="addto-wrap">
                                      <a class="add-cart" href="cart.html">
                          ...
                          <div class="swiper-slide">
                            ...
                            <div class="product-item">
                              <div class="inner-content">
                                <div class="product-thumb">
                                  <a href="single-product-simple.html">
                                    <img class="w-100" src="<?= base_url()?>/assets/site/img/shop/5.jpg" alt="Image-HasTech">
                                  </a>
                                  <div class="product-action">
                                    <div class="addto-wrap">
                                      <a class="add-cart" href="cart.html">
                            ...
                            <div class="product-item">
                              <div class="inner-content">
                                <div class="product-thumb">
                                  <a href="single-product-simple.html">
                                    <img class="w-100" src="<?= base_url()?>/assets/site/img/shop/6.jpg" alt="Image-HasTech">
                                  </a>
                                  <div class="product-action">
                                    <div class="addto-wrap">
                                      <a class="add-cart" href="cart.html">
                          ...
                          <div class="swiper-slide">
                            ...
                            <div class="product-item">
                              <div class="inner-content">
                                <div class="product-thumb">
                                  <a href="single-product-simple.html">
                                    <img class="w-100" src="<?= base_url()?>/assets/site/img/shop/7.jpg" alt="Image-HasTech">
                                  </a>
                                  <div class="product-action">
                                    <div class="addto-wrap">
                                      <a class="add-cart" href="cart.html">
                            ...
                            <div class="product-item">
                              <div class="inner-content">
                                <div class="product-thumb">
                                  <a href="single-product-simple.html">
                                    <img class="w-100" src="<?= base_url()?>/assets/site/img/shop/8.jpg" alt="Image-HasTech">
                                  </a>
                                  <div class="product-action">
                                    <div class="addto-wrap">
                                      <a class="add-cart" href="cart.html">
                          ...
                          <div class="swiper-slide">
                            ...
                            <div class="product-item">
                              <div class="inner-content">
                                <div class="product-thumb">
                                  <a href="single-product-simple.html">
                                    <img class="w-100" src="<?= base_url()?>/assets/site/img/shop/9.jpg" alt="Image-HasTech">
                                  </a>
                                  <div class="product-action">
                                    <div class="addto-wrap">
                                      <a class="add-cart" href="cart.html">
                            ...
                            <div class="product-item">
                              <div class="inner-content">
                                <div class="product-thumb">
                                  <a href="single-product-simple.html">
                                    <img class="w-100" src="<?= base_url()?>/assets/site/img/shop/11.jpg" alt="Image-HasTech">
                                  </a>
                                  <span class="sale-title sticker">Sale</span>
                          ...
                          <div class="swiper-slide">
                            ...
                            <div class="product-item">
                              <div class="inner-content">
                                <div class="product-thumb">
                                  <a href="single-product-simple.html">
                                    <img class="w-100" src="<?= base_url()?>/assets/site/img/shop/13.jpg" alt="Image-HasTech">
                                  </a>
                            ...
                            <div class="product-item">
                              <div class="inner-content">
                                <div class="product-thumb">
                                  <a href="single-product-simple.html">
                                    <img class="w-100" src="<?= base_url()?>/assets/site/img/shop/15.jpg" alt="Image-HasTech">
                                  </a>
                                  <div class="product-action">
                                    <div class="addto-wrap">
                                      <a class="add-cart" href="cart.html">
                          ...
                          <div class="swiper-slide">
                            ...
                            <div class="product-item">
                              <div class="inner-content">
                                <div class="product-thumb">
                                  <a href="single-product-simple.html">
                                    <img class="w-100" src="<?= base_url()?>/assets/site/img/shop/10.jpg" alt="Image-HasTech">
                                  </a>
                                  <div class="product-action">
                                    <div class="addto-wrap">
                                      <a class="add-cart" href="cart.html">
                            ...
                            <div class="product-item">
                              <div class="inner-content">
                                <div class="product-thumb">
                                  <a href="single-product-simple.html">
                                    <img class="w-100" src="<?= base_url()?>/assets/site/img/shop/12.jpg" alt="Image-HasTech">
                                  </a>
                                  <div class="product-action">
                                    <div class="addto-wrap">
                                      <a class="add-cart" href="cart.html">
                          ...
                          <div class="swiper-slide">
                            ...
                            <div class="product-item">
                              <div class="inner-content">
                                <div class="product-thumb">
                                  <a href="single-product-simple.html">
                                    <img class="w-100" src="<?= base_url()?>/assets/site/img/shop/14.jpg" alt="Image-HasTech">
                                  </a>
                                  <div class="product-action">
                                    <div class="addto-wrap">
                                      <a class="add-cart" href="cart.html">
                            ...
                            <div class="product-item">
                              <div class="inner-content">
                                <div class="product-thumb">
                                  <a href="single-product-simple.html">
                                    <img class="w-100" src="<?= base_url()?>/assets/site/img/shop/16.jpg" alt="Image-HasTech">
                                  </a>
                                  <div class="product-action">
                                    <div class="addto-wrap">
                                      <a class="add-cart" href="cart.html">
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3 d-none d-lg-block">
                      ...
                      <div class="product-item">
                        <div class="inner-content">
                          <div class="product-thumb">
                            <a href="single-product-simple.html">
                              <img class="w-100" src="<?= base_url()?>/assets/site/img/shop/19.jpg" alt="Image-HasTech">
                            </a>
                            <span class="sale-title sticker">Sale</span>
        ...
        <div class="row">
          <div class="col-sm-6">
            ...
            <div class="single-banner-image">
              <a href="shop.html">
                <img class="w-100" src="<?= base_url()?>/assets/site/img/shop/banner/3.jpg" alt="Image-HasTech">
              </a>
            </div>
          ...
          <div class="col-sm-6">
            ...
            <div class="single-banner-image mb-0">
              <a href="shop.html">
                <img class="w-100" src="<?= base_url()?>/assets/site/img/shop/banner/4.jpg" alt="Image-HasTech">
              </a>
            </div>
            <!--== End Single Banner Item ==-->
          </div>
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    ...
                    <div class="brand-logo-item">
                      <a href="shop.html"><img src="<?= base_url()?>/assets/site/img/brand-logo/1.jpg" alt="Image-HasTech"></a>
                    </div>
                    <!--== End Brand Logo Item ==-->
                  </div>
                  <div class="swiper-slide">
                    <!--== Start Brand Logo Item ==-->
                    <div class="brand-logo-item">
                      <a href="shop.html"><img src="<?= base_url()?>/assets/site/img/brand-logo/2.jpg" alt="Image-HasTech"></a>
                    </div>
                    <!--== End Brand Logo Item ==-->
                  </div>
                  <div class="swiper-slide">
                    <!--== Start Brand Logo Item ==-->
                    <div class="brand-logo-item">
                      <a href="shop.html"><img src="<?= base_url()?>/assets/site/img/brand-logo/3.jpg" alt="Image-HasTech"></a>
                    </div>
                    <!--== End Brand Logo Item ==-->
                  </div>
                  <div class="swiper-slide">
                    <!--== Start Brand Logo Item ==-->
                    <div class="brand-logo-item">
                      <a href="shop.html"><img src="<?= base_url()?>/assets/site/img/brand-logo/4.jpg" alt="Image-HasTech"></a>
                    </div>
                    <!--== End Brand Logo Item ==-->
                  </div>
                  <div class="swiper-slide">
                    <!--== Start Brand Logo Item ==-->
                    <div class="brand-logo-item">
                      <a href="shop.html"><img src="<?= base_url()?>/assets/site/img/brand-logo/5.jpg" alt="Image-HasTech"></a>
                    </div>
                    <!--== End Brand Logo Item ==-->
                  </div>
                  <div class="swiper-slide">
                    <!--== Start Brand Logo Item ==-->
                    <div class="brand-logo-item">
                      <a href="shop.html"><img src="<?= base_url()?>/assets/site/img/brand-logo/6.jpg" alt="Image-HasTech"></a>
                    </div>
                    <!--== End Brand Logo Item ==-->
                  </div>
                  <div class="swiper-slide">
                    <!--== Start Brand Logo Item ==-->
                    <div class="brand-logo-item">
                      <a href="shop.html"><img src="<?= base_url()?>/assets/site/img/brand-logo/7.jpg" alt="Image-HasTech"></a>
                    </div>
                    <!--== End Brand Logo Item ==-->
                  </div>
                </div>
                    ...
                    <div class="inner-content">
                      <div class="thumb">
                        <a href="single-blog.html">
                          <img class="w-100" src="<?= base_url()?>/assets/site/img/blog/1.jpg" alt="Image-HasTech">
                        </a>
                      </div>
                      <div class="content">
                        <ul class="meta">
                ...
                <div class="swiper-slide">
                  ...
                  <div class="post-item">
                    <div class="inner-content">
                      <div class="thumb">
                        <a href="single-blog.html">
                          <img class="w-100" src="<?= base_url()?>/assets/site/img/blog/2.jpg" alt="Image-HasTech">
                        </a>
                      </div>
                      <div class="content">
                        <ul class="meta">
                ...
                <div class="swiper-slide">
                  ...
                  <div class="post-item">
                    <div class="inner-content">
                      <div class="thumb">
                        <a href="single-blog.html">
                          <img class="w-100" src="<?= base_url()?>/assets/site/img/blog/3.jpg" alt="Image-HasTech">
                        </a>
                      </div>
                      <div class="content">
                        <ul class="meta">
                          <li><span>post by: </span><a class="author" href="blog.html">Adapo</a></li>
                          <li><span> - Jan, 20 , 22</span></li>
                        </ul>
  ...
  <footer class="footer-area">
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <p class="copyright">Copyright &copy; 2021.Company name All rights reserved.<a target="_blank" href="https://sc.chinaz.com/moban/">&#x7F51;&#x9875;&#x6A21;&#x677F;</a></p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="product-quick-view-content">
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 col-12">
            <div class="thumb">
              <img src="<?= base_url()?>/assets/site/img/shop/quick-view1.jpg" alt="Alan-Shop">
            </div>
          </div>
          <div class="col-lg-6 col-md-6 col-12">
            <div class="content">
...
<script src="<?= base_url()?>/assets/site/js/modernizr.js"></script>
<!--=== jQuery Min Js ===-->
<script src="<?= base_url()?>/assets/site/js/jquery-main.js"></script>
<!--=== jQuery Migration Min Js ===-->
<script src="<?= base_url()?>/assets/site/js/jquery-migrate.js"></script>
...
<script src="<?= base_url()?>/assets/site/js/headroom.min.js"></script>
<!--=== jQuery Swiper Min Js ===-->
<script src="<?= base_url()?>/assets/site/js/swiper.min.js"></script>
<!--=== jQuery Fancybox Min Js ===-->
<script src="<?= base_url()?>/assets/site/js/fancybox.min.js"></script>
<!--=== jQuery Slick Nav Js ===-->
<script src="<?= base_url()?>/assets/site/js/slicknav.js"></script>
<!--=== jQuery Countdown Js ===-->
<script src="<?= base_url()?>/assets/site/js/countdown.js"></script>

<!--=== jQuery Custom Js ===-->
<script src="<?= base_url()?>/assets/site/js/custom.js"></script>
