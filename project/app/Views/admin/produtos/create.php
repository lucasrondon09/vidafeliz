        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?= base_url('/Admin/Produtos')?>">Notícias</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <?= form_open(base_url('Admin/Produtos/cadastrar')) ?>
              <?= csrf_field() ?>
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-8">
                    ...
                    <div class="col-md-4">
                      <div class="card w-100">
                        ...
                        <div class="card-body">
                          <div class="form-group">
                            <label class="mr-3">Publicar produto:</label>
                            <input type="checkbox" name="status" value="1" checked data-bootstrap-switch>
                          </div>
                          <div class="form-group">
                            <label>Data da publicação:</label>
                            <input type="date" class="form-control" value="<?= date('Y-m-d');?>" name="dataCadastro">
                          </div>
         ...
         <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="<?= base_url('Admin/Produtos-Categorias/cadastrarAjax')?>" id="formCategoria" method="post">
                    <div class="form-group">
