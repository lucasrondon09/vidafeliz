        ...
        <?= csrf_field() ?>
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" name="login" class="form-control" id="login" name="login" value="<?= isset($record) ? $record->login : set_value('login') ?>">
            </div>
            <div class="form-group">
              <label for="login">Perfil</label>
            <?php if (isset($record->perfil)): ?>
              <select name="perfil" class="form-control" id="perfil">
                <option value="1" <?= $record->perfil == 1 ? 'selected' : '' ?>>Administrador</option>
                <option value="2" <?= $record->perfil == 2 ? 'selected' : '' ?>>Secretária</option>
                <option value="3" <?= $record->perfil == 3 ? 'selected' : '' ?>>Professor</option>
              </select>
            <?php else: ?>
              <select name="perfil" class="form-control" id="perfil">
