        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?= base_url('Admin/Banners')?>">Notícias</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <?= form_open_multipart(base_url('Admin/Banners/uploadImagens').'/'.$field->id) ?>
              <?= csrf_field() ?>
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-12">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-3 mb-4">
                    ...
                    <a href="Admin/Banners/deleteImage/<?= $imagesItem->id.'/'.$field->id;?>" class="btn btn-danger w-100 font-weight-bold mt-2" onClick="return deletar()">Excluir</a>
                  </div>
                  <?php 
                  endforeach;
                  else:
